...
<head profile="http://www.w3.org/1999/xhtml/vocab">
    <title>Xem chi tiết đơn hàng ký gửi | THƯƠNG ĐÔ LOGISTICS</title>
...
<body
    class="html not-front logged-in no-sidebars page-don-hang page-don-hang-ky-gui page-don-hang-ky-gui-detail dashboard-page page-no-right">
    ...
    <div class="main-dashboard block-both">
        ...
        <div class="content-dashboard">
            <div class="content-dashboard-top block-both">
                <div class="content-dashboard-top-inner">
                    ...
                    <div class="tim-kiem-search-form">
                        <form class="tim-kiem-add-form" target="_blank" action="/don-hang/ky-gui/detail?id=233644"
                            method="post" id="baiviet-tim-kiem-add-form" accept-charset="UTF-8">
                            <div>
                                <div class="search-text">
                                    ...
                                    value="form-TTVMzR468CrHmz7RnNjXv1gxEl907j857XrwknyAR3I" />
            ...
            <div class="content-page-center">
                ...
                <div class="don-hang-ky-gui-detail">
                    <div class="kien-hang-list-item">
                        <div class="tracking-order-process">
                            <p class="order-id"></p>
                            <div>Mã đơn hàng: <b>{{$tin->madon}}
                                </b></div>
                            <div class="status-track">
                                <b>Tình trạng đơn hàng:</b> <span style="color:red">{{$tin->tinhtrang}}</span>
                            </div>
                            <div class="uk-grid uk-grid-small bs-wizard">
                                <div class="tracking-active uk-width-1-3 bs-wizard-step">
                                    <div class="uk-text-center bs-wizard-stepnum">
                                        <p>Chờ xử lý</p>
                                        <span class="track-date"></span>
                                    </div>
                                    <div class="progress">
                                ...
                                <div class=" uk-width-1-3 bs-wizard-step">
                                    <div class="uk-text-center bs-wizard-stepnum">
                                        <p>Đang xử lý</p>
                                        <span class="track-date"></span>
                                    </div>
                        ...
                        <div class="item">
                            <div class="top">
                                <strong>Mã kiện: {{$tin->madon}}</strong> <span class="status blue">{{$tin->tinhtrang}}</span><span
                                    class="post-date uk-float-right">{{$tin->created_at}}</span>
                            </div>
                            <table>
                                <tbody>
                                    <tr>
                                        <td>Mã đơn hàng</td>
                                        <td>Loại hàng</td>
                                        <td>Cân nặng thực tế</td>
                                        <td>Cân nặng làm tròn</td>
                            ...
                            <div class="dia-chi-giao-hang">
                                <div class="top">Địa chỉ nhận hàng</div>
                                <p>{{$tin->diachi}}
                                </p>
                            </div>
                        </div>
