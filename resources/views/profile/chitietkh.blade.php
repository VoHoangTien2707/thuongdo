                ...
                <div class="don-hang-detail-inner don-hang-ky-gui-table-list">
                    <div class="menu-don-hang">
                        <ul class="step-action">
                            <li><a href="/">Chờ xử lý<span class="uk-badge uk-badge-notification "
                                        style="margin-left: 5px"> 1</span></a></li>
                            <li><a href="/">Đang xử lý<span class="uk-badge uk-badge-notification "
                                        style="margin-left: 5px"> 0</span></a></li>
                            <li><a href="/">Đã hoàn thành<span class="uk-badge uk-badge-notification "
                                        style="margin-left: 5px"> 0</span></a></li>
                        </ul>
                    </div>
                    <form class="don-hang-search-form" action="/don-hang/ky-gui" method="post"
                        ...
                        <div>
                            ...
                            <div class="form-item form-type-select form-item-kho">
                                <select id="edit-kho" name="kho" class="form-select">
                                    <option value="" selected="selected">Chọn kho nhận</option>
                            ...
                            <div class="form-item form-type-textfield form-item-order-code">
                                <input placeholder="Mã đơn hàng" type="text" id="edit-order-code" name="order_code"
                                    ...
                                    <div id="edit-month-to" class="date-padding">
                                        <div class="form-item form-type-textfield form-item-month-to-date">
                                            ...
                                            <input placeholder="Từ ngày" type="text"
                                                id="edit-month-to-datepicker-popup-0" name="month_to[date]" value=""
                            ...
                            <div class="container-inline-date">
                                    ...
                                    <div id="edit-month-end" class="date-padding">
                                        <div class="form-item form-type-textfield form-item-month-end-date">
                                            ...
                                            <input placeholder="Đến ngày" type="text"
                                                id="edit-month-end-datepicker-popup-0" name="month_end[date]" value=""
                                                size="20" maxlength="30" class="form-text" />
                                            <div class="description"> E.g., 21/09/2023</div>
                                        </div>
                                    </div>
                                ...
                                class="form-submit" /><input type="hidden" name="form_build_id"
                                value="form-KNm_KGpfggYTaH8b0_BvBKcIG5fYeuzo6j5j-zo5w4w" />
                            <input type="hidden" name="form_token"
                                value="VLTWRzs6dEePgA5ldueglFtOA0cVbtCJg8IshuY90VU" />
                            <input type="hidden" name="form_id" value="don_hang_ky_gui_search_form" />
                        </div>
                    </form>
                    <table class="don-hang-cua-ban-item don-hang-ky-gui-table-list sticky-enabled">
                        ...
                        <tbody>
                            ...
                            <tr class="odd">
                                <td>1</td>
                                <td><a href="/don-hang/ky-gui/detail?id=233644">{{$data->madon}}
                                    </a></td>
                                <td>{{$data->created_at}}</td>
                                <td><span class="label-bs label-bs-success" style="background:#5cb85c">{{$data->chieugui}}</span>
                                </td>
                                <td>{{$data->sokh}}</td>
                                <td><span class="status red">{{$data->trangthai}}</span></td>
                                <td>
                                    <div class="action"><a href="{{route('kienhang.edit',['id'=>$data->id])}}"><i
