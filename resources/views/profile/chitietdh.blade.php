        ...
        <div class="content-dashboard">
            ...
            <div class="content-page-center">
                ...
                <ul class="step-action">
                        <li class=""><a href="/don-hang?status=1" class="active">Chờ báo giá<span
                ...
                <div class="order-item block-both">
                    ...
                    <div class="order-item-product block-both">
                                    ...
                                    <table>
                                        <tr>
                                            <td width="40%">
                                                <a href="https://login.taobao.com/member/login.jhtml?redirectURL=https%3a%2f%2fitem.taobao.com:443/item.htm%2F_____tmd_____%2Fpage%2Flogin_jump%3Frand%3DS3WxGHAgAt756EpznwfNzJq2AFA2qBNla3j6EINUS8We9dazM_iKElp8DwVSHZUevpC41Bx7RzivXIj9RnZgdg%26_lgt_%3D74b4fca76"
                                                    ...
                                                    <img class="imghinh" style="widh:30%"
                                                        src="{{ asset('images/' . $data->img) }}"
                                                        alt="Hình ảnh sản phẩm">
                                                </a>
                                                <a href="https://login.taobao.com/member/login.jhtml?redirectURL=https%3a%2f%2fitem.taobao.com:443/item.htm%2F_____tmd_____%2Fpage%2Flogin_jump%3Frand%3DS3WxGHAgAt756EpznwfNzJq2AFA2qBNla3j6EINUS8We9dazM_iKElp8DwVSHZUevpC41Bx7RzivXIj9RnZgdg%26_lgt_%3D74b4fca76"
                                                    class="title">{{$data->tensp}}</a>
                                                <span class="property">{{$data->chitietsp}}</span>
                                            </td>
                                            <td width="10%" class="center">Số lượng: {{$data->soluong}}</td>
                                            <td width="15%" class="center">
                                                <span class="price-vnd price-red">{{$data->gia}}đ</span><br />
                                                <span class="price-cny">¥ 20.00</span>
                                            </td>
                                            <td width="15%" class="center">
                                                <span class="thanh-tien-vnd price-red">{{$data->thanhtien}}</span><br />
                                        ...
                                        <tr>
                                            <td colspan="5" class="center">Tổng tiền : <b
                                                    class="price-red">{{$data->thanhtien}}đ</b></td>
                                        </tr>
                                    </table>
                                </div>
                        ...
                        <div class="order-item-product-right">
                            <ul>
                                <li>Tổng tiền hàng: <b>{{$totalOrderAmount}}đ</b></li>
                                <li>Phí đặt hàng: <b>9.000</b><sup>đ</sup></li>
                                <li>Phí kiểm đếm: <b>0</b><sup>đ</sup></li>
                                <li>Phí ship TQ: <b>0</b><sup>đ</sup></li>

                                <li>Tổng tiền đơn hàng: <b>{{$totalOrderAmount}}đ</b></li>
                                <li class="blue">Đặt cọc: <b>0đ</b></li>
                                <li class="blue">Còn lại: <b>-{{$totalOrderAmount}}đ</b></li>
                            </ul>

                            <div class="action block-both"><a href="/don-hang-view?order_id=1304370"
                                    title="Xem chi tiết" data-uk-tooltip="" class="xem-chi-tiet"><i
                                        class="fa fa-th-list" aria-hidden="true"></i> Xem chi tiết</a><a
                                    href="/gio-hang/edit?orderID=1304370" title="Sửa đơn hàng" data-uk-tooltip=""><i
                                        class="fa fa-pencil-square-o" aria-hidden="true"></i> Sửa đơn hàng</a><a
                                    title="Hủy đơn hàng" data-uk-tooltip="" class="huy-don"
                                    onclick="don_hang_huy_item(1304370);" href="javascript:void(0);"><i
                                        class="fa fa-ban" aria-hidden="true"></i> Hủy đơn</a><a
                                    href="/don-hang/export?order-id=1304370" data-uk-tooltip="" title="Xuất excel"><i
                                        class="fa fa-file-excel-o" aria-hidden="true"></i> Xuất excel</a></div>
                        </div>
                    </div>
                </div>
            </div>
