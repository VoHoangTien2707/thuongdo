...
$listtin = DB::table('tbl_tintuc')->where('iddm', $iddm)
->where('id','!=',$dv->id)
->get();
        ...
        {!! $dv->content !!}
            ...
            <h3>Bài viết liên quan</h3>
                    ...
                    <ul><li class="first-below ">
                        ...
                        <li>                                                <a href="{{ url('/chitiettin',[$tin->id]) }}" title="DỊCH VỤ ĐẶT HÀNG TRUNG QUỐC" class="active"><i class="fa fa-caret-right" aria-hidden="true"></i>{{$tin->title}}</a>
</li>
