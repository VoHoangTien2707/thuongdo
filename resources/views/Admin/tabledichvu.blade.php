                    ...
                    <div class="tile-body">
                        <div class="row element-button">
                            <div class="col-sm-2">
                              ...
                              <a class="btn btn-add btn-sm" href="{{route('admin.tabledv.add')}}" title="Thêm"><i class="fas fa-plus"></i>
                                Tạo mới dịch vụ</a>
                            </div>
                            <div class="col-sm-2">
...
<td><a href="{{route('admin.tabledv.delete',['id'=>$dt->id])}}"><button class="btn btn-primary btn-sm trash" type="button" title="Xóa"
        ><i class="fas fa-trash-alt"></i>
    </button></a>

    <a href="{{route('admin.tabledv.edit',['id'=>$dt->id])}}"> <button class="btn btn-primary btn-sm edit" type="button" title="Sửa" id="show-emp"><i class="fas fa-edit"></i></button></a>
...
// Hàm để hiển thị dữ liệu trên từng trang
        ...
        if (data[i]) {
            ...
            row.innerHTML = `
                ...
                <td>
                    ...
                    <a href="{{route('admin.tabledv.edit',['id'=>$dt->id])}}">
