...
<main class="app-content">
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb side">
                <li class="breadcrumb-item active"><a href="#"><b>Danh sách Hướng dẫn</b></a></li>
            </ul>
            <div id="clock"></div>
        </div>
        <div class="row">
...
<td>
    <a href="{{route('admin.tablehg.delete',['id'=>$dt->id])}}"><button class="btn btn-primary btn-sm trash" type="button" title="Xóa"
        ><i class="fas fa-trash-alt"></i>
    </button></a>

    <a href="{{route('admin.tablehg.edit',['id'=>$dt->id])}}"> <button class="btn btn-primary btn-sm edit" type="button" title="Sửa" id="show-emp"><i class="fas fa-edit"></i></button></a>
