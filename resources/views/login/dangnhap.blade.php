...
<head profile="http://www.w3.org/1999/xhtml/vocab">
  <title>Tài khoản người dùng | THƯƠNG ĐÔ LOGISTICS</title>
...
@import url("https://www.thuongdo.com/sites/all/modules/contrib/gauth/gauth_login/gauth_login.css?s0lpgf");
...
<body class="html not-front not-logged-in no-sidebars page-user  " >
  <div class="olay-css" style="display: none;"></div>
    ...
    <div class="user-content block-clear">
        <div class="top">
			<h1>Đăng nhập</h1>
			<h2><a href="{{ url('/dangky') }}">Tạo tài khoản</a></h2>
		</div>
        <form class="user-login-form" action="/login" method="post" id="user-login" accept-charset="UTF-8">
    @csrf

    <div class="form-item form-type-textfield form-item-name">
        <label class="element-invisible" for="edit-name">Tên người dùng <span class="form-required" title="Trường dữ liệu này là bắt buộc.">*</span></label>
        <input tabindex="1" placeholder="Email" type="text" id="edit-name" name="email" value="{{ old('email') }}" size="60" maxlength="60" class="form-text required" />
        <span class="field-suffix"><i class="fa fa-user-circle"></i></span>
    ...
    <div class="form-item form-type-password form-item-pass">
        ...
        <input tabindex="1" placeholder="Mật khẩu..." type="password" id="edit-pass" name="password" size="60" maxlength="128" class="form-text required" />
        <span class="field-suffix"><i class="fa fa-lock"></i></span>

    </div>

    <input type="hidden" name="form_build_id" value="form-U7uDnEmRza8EqcCQHnM2kfW2oVnBpjKTcf0O8aXHVIw" />
    <input type="hidden" name="form_id" value="user_login" />

    <input type="submit" value="Submit">
    <input tabindex="1" type="checkbox" id="edit-remember-me" name="remember_me" value="1" checked="checked" class="form-checkbox" />
    <label class="option" for="edit-remember-me">Duy trì đăng nhập</label>
...
<script>
    ...
    document.getElementById('user-login').addEventListener('submit', function (event) {
        ...
        var email = document.getElementById('edit-name').value;
        var password = document.getElementById('edit-pass').value;

        // Kiểm tra và hiển thị thông báo lỗi nếu có
        if (!email || !password) {
            // Sử dụng Toastr.js để hiển thị thông báo lỗi
            toastr.error('Vui lòng điền đầy đủ email và mật khẩu.', 'Lỗi');
            return;
        }
