...
<head profile="http://www.w3.org/1999/xhtml/vocab">
  <title>Đăng ký | THƯƠNG ĐÔ LOGISTICS</title>
...
<script src="link_to_toastr_js_file"></script> <!-- Thay link_to_toastr_js_file bằng đường dẫn đến file Toastr JS -->
...
<style type="text/css" media="all">
@import url("https://www.thuongdo.com/sites/all/modules/contrib/jquery_update/replace/ui/themes/base/minified/jquery.ui.core.min.css?s0lpgf");
@import url("https://www.thuongdo.com/sites/all/modules/contrib/jquery_update/replace/ui/themes/base/minified/jquery.ui.theme.min.css?s0lpgf");
</style>
<style type="text/css" media="all">
...
@import url("https://www.thuongdo.com/sites/all/modules/contrib/ctools/css/modal.css?s0lpgf");
@import url("https://www.thuongdo.com/sites/all/themes/giaodiennguoidung/css/responsive-modal.css?s0lpgf");
</style>
<style type="text/css" media="all">
...
<body class="html not-front not-logged-in no-sidebars page-dang-ky  " >
  <div class="olay-css" style="display: none;"></div>
    ...
    <div class="left-user">
    	...
    	<ul>
    		<li><a href="/dat-hang-trung-quoc" title="Dịch vụ đặt hàng Trung Quốc">Dịch vụ đặt hàng Trung Quốc</a></li>
    		<li><a href="/van-chuyen-hang-trung-quoc" title="Vận chuyển hàng Trung Quốc">Vận chuyển hàng Trung Quốc</a></li>
    		<li><a href="/ghep-nhom-danh-hang-quang-chau-trung-quoc-tiet-kiem-chi-phi" title="Ghép nhóm đánh hàng">Ghép nhóm đánh hàng</a></li>
    		<li><a href="/dich-vu-doi-tien-chuyen-tien-trung-quoc-viet-nam-ty-gia-nhan-dan-te-cny-rmb" title="Chuyển tiền Trung Quốc">Chuyển tiền Trung Quốc</a></li>
    	</ul>
    ...
    <div class="user-content block-clear">
        <div class="top">
			<h1>Tạo tài khoản</h1>
			<h2><a href="{{ url('/dangnhap') }}">Đăng nhập</a></h2>
            <i>Tạo tài khoản để tìm kiếm nguồn hàng, đặt hàng, theo dõi đơn hàng, nhận những chương trình khuyến mại, phản hồi khiếu nại, thắc mắc về dịch vụ...</i>
		</div>
        <form class="don-hang-dang-ky-form user-register-form" action="/register" method="post" id="don-hang-dang-ky-form" accept-charset="UTF-8"><div><div class="form-item form-type-textfield form-item-fullname">
            @csrf

  <label class="element-invisible" for="edit-fullname">Họ và tên <span class="form-required" title="Trường dữ liệu này là bắt buộc.">*</span></label>
 <input placeholder="Họ và tên (*)" type="text" id="edit-fullname" name="name" value="" size="60" maxlength="128" class="form-text required" /> <span class="field-suffix"><i class="fa fa-user-o" aria-hidden="true"></i></span>
 @error('name')
            <div class="error-message">{{ $message }}</div>
        @enderror
</div>
<div class="form-item form-type-password form-item-pass">
  <label class="element-invisible" for="edit-pass">Mật khẩu <span class="form-required" title="Trường dữ liệu này là bắt buộc.">*</span></label>
 <input placeholder="Mật khẩu (*)" type="password" id="edit-pass" name="password" size="60" maxlength="128" class="form-text required" /> <span class="field-suffix"><i class="fa fa-unlock-alt" aria-hidden="true"></i></span>
 @error('password')
            <div class="error-message">{{ $message }}</div>
        @enderror
</div>
<div class="form-item form-type-textfield form-item-email">
  <label class="element-invisible" for="edit-email">Email <span class="form-required" title="Trường dữ liệu này là bắt buộc.">*</span></label>
 <input placeholder="Thư điện tử (*)" onKeyup="khach_hang_register_validate(&#039;email&#039;);" type="text" id="edit-email" name="email" value="" size="60" maxlength="128" class="form-text required" /> <span class="field-suffix"><i class="fa fa-envelope-o" aria-hidden="true"></i></span>
 @error('email')
            <div class="error-message">{{ $message }}</div>
        @enderror
</div>
<div class="form-item form-type-textfield form-item-phone">
  <label class="element-invisible" for="edit-phone">Số điện thoại <span class="form-required" title="Trường dữ liệu này là bắt buộc.">*</span></label>
 <input placeholder="Số điện thoại (*) để nhận các thông báo về đơn hàng" onKeyup="khach_hang_register_validate(&#039;phone&#039;);" type="text" id="edit-phone" name="phone" value="" size="60" maxlength="128" class="form-text required" /> <span class="field-suffix"><i class="fa fa-mobile" aria-hidden="true"></i></span>
 @error('phone')
            <div class="error-message">{{ $message }}</div>
        @enderror
</div>
<div class="form-item form-type-select form-item-kho-id">
 <select id="edit-kho-id" name="kho_id" class="form-select"><option value="" selected="selected">Chọn kho nhận hàng (*)</option><option value="[Hà Nội] - Trần Điền, Thanh Xuân">[Hà Nội] - Trần Điền, Thanh Xuân</option><option value="[Hà Nội] - Tạ Quang Bửu, Hai Bà Trưng">[Hà Nội] - Tạ Quang Bửu, Hai Bà Trưng</option><option value="[Hà Nội] - Mỗ Lao, Hà Đông">[Hà Nội] - Mỗ Lao, Hà Đông</option><option value="[Hồ Chí Minh] - Nguyên Văn Luông, Quận 6">[Hồ Chí Minh] - Nguyên Văn Luông, Quận 6</option></select>
 @error('kho_id')
            <div class="error-message">{{ $message }}</div>
        @enderror
</div>
<div class="form-item form-type-textfield form-item-referral">
 ...
 <input placeholder="Mã nhân viên tư vấn (Không bắt buộc)" type="text" id="edit-referral" name="manv" value="" size="60" maxlength="128" class="form-text" /> <span class="field-suffix"><i class="fa fa-users" aria-hidden="true"></i></span>
</div>
<div class="form-item form-type-select form-item-type">
 <select id="edit-type" name="dichvu" class="form-select"><option value="" selected="selected">Chọn dịch vụ (*)</option><option value="Đặt hàng">Đặt hàng</option><option value="Ký gửi hàng">Ký gửi hàng</option></select>
 @error('dichvu')
            <div class="error-message">{{ $message }}</div>
        @enderror
</div>
<div class="form-item form-type-checkbox form-item-agree">
 <input type="checkbox" id="edit-agree" name="agree" value="1" checked="checked" class="form-checkbox required" />  <label class="option" for="edit-agree">Tôi đã đọc và đồng ý với <a href="https://www.thuongdo.com/quy-dinh-ve-ky-gui-hang">điều khoản</a> của Thương Đô <span class="form-required" title="Trường dữ liệu này là bắt buộc.">*</span></label>

</div>
<input type="submit" id="edit-submit" name="op" value="Đăng ký" class="form-submit" /><div class="login-use-social">
                            <div class="btn-login btn-facebook">
                                <i class="fa fa-facebook" aria-hidden="true"></i>
                                <a href="/user/simple-fb-connect"><span>Đăng nhập bằng Facebook</span></a>
                            </div>
                            <div class="btn-login btn-google">
                                <i class="fa fa-google-plus-circle" aria-hidden="true"></i>
                                <a href="/user/simple-google-connect"><span>Đăng nhập bằng Google</span></a>
                            </div>
                          </div>
                          <input type="hidden" name="form_build_id" value="form-v6CTQXPeukLGOXOrAhwLheuWHbS9HHj1gA94V7uF5Bc" />
<input type="hidden" name="form_id" value="don_hang_dang_ky_form" />
</div></form>

<script>
    // Kiểm tra nếu có thông báo lỗi từ Laravel
    @if(isset($message))

    @if ($errors->any())
        // Hiển thị mỗi thông báo lỗi dưới dạng toast message
...
<script type="text/javascript" src="https://www.thuongdo.com/sites/all/modules/contrib/ctools/js/modal.js?s0lpgf"></script>
